...
class CompanySensorDetail extends StatefulWidget {
  CompanySensorDetail({
    super.key,
  ...
  @override
  State<CompanySensorDetail> createState() => _SensorDetailState();
}

class _SensorDetailState extends State<CompanySensorDetail> {
  @override
