...
public class GenerateUrl {
    ...
    public String generateUrl(ServerType serverType, String id, SubmodelType submodelType) {
        if(serverType == ServerType.AasRegistry)
        {
            ...
            return this.aasServerUrlBasic + "/" + id + "aas/submodels/" + submodelType.toString().charAt(0) + id;
        }
    }
    ...
    public String generateUrl(String id, StaticSubmodelElementType staticSubmodelElementType) {
        return this.aasServerUrlBasic + "/" + id + "/submodels/" + SubmodelType.Static.toString().charAt(0) + id + "/submodel/submodelElements/" + staticSubmodelElementType + id;
    }
    ...
    public String generateUrl(String id, DynamicSubmodelElementType dynamicSubmodelElementType) {
        return this.aasServerUrlBasic + "/" + id + "/submodels/" + SubmodelType.Dynamic.toString().charAt(0) + id + "/submodel/submodelElements/" + dynamicSubmodelElementType + id;
    }
}
