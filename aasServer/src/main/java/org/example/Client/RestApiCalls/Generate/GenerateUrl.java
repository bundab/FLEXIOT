...
public class GenerateUrl {
    private final String aasRegistryUrlBasic = "http://192.168.188.3:4000/registry/api/v1/registry";
    private final String aasServerUrlBasic = "http://192.168.188.3:4001/aasServer/shells";
